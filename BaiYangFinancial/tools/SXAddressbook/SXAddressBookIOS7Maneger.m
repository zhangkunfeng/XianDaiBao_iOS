...
- (NSArray *)getPersonInfoArray
{
    ...
    for (int i = 0; i < peopleCount; i++) {
        ...
        NSString * mobileId = (__bridge_transfer NSString *)ABRecordCopyValue(person, kABPersonKindProperty);
        ...
        NSString *dateStr = [formater stringFromDate:creatTime];//将日期转换成字符串
        NSLog(@"%@",dateStr);
        personEntity.dateStr = dateStr;
