...
- (void)settingTextIndicatorColorIsChange:(BOOL)isChange
{
    if (isChange) {
        _textIndicator.textColor = [UIColor whiteColor];
        _stateIndicatorView.image = [UIImage imageNamed:@"sdRefeshView_arrow_white@2x"];
...
- (void)layoutSubviews
{
    ...
    _textIndicator.center = CGPointMake(self.sd_width * 0.5, _activityIndicatorView.sd_height * 0.5 + 35);
    //原始的时间和状态说明
