...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.triangleColor =  [UIColor colorWithHexString:@"448b51"];//[UIColor whiteColor];
        self.triangleY = 64;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    /*后加*/
    cell.menuTotal = _menuViewTotal;
    [cell setRoundLabelValues];
    
    if (indexPath.row == self.menuModelsArray.count-1) {
        [cell setLineLabelHidden];
    }
