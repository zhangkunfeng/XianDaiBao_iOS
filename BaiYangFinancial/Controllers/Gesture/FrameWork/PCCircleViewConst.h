 ...
 *  选中状态下外空心圆颜色
 */
#define CircleStateSelectedOutsideColor rgba(255,255,255,1)//(34, 178, 246, 1)

/**
 *  错误状态下外空心圆颜色
 */
#define CircleStateErrorOutsideColor rgba(255,255,255,1)//(254, 82, 92, 1)
 ...
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor rgba(255,255,255,1)//(34, 178, 246, 1)

/**
 *  错误状态内实心圆颜色
 */
#define CircleStateErrorInsideColor rgba(255,255,255,1)//(254, 82, 92, 1)
 ...
 *  选中状态下三角形颜色
 */
#define CircleStateSelectedTrangleColor rgba(255,255,255,1)//(34, 178, 246, 1)

/**
 *  错误状态三角形颜色
 */
#define CircleStateErrorTrangleColor rgba(255,255,255,1)//(254, 82, 92, 1)
 ...
 *  普通时连线颜色
 */
#define CircleConnectLineNormalColor rgba(255,255,255,1)//(34, 178, 246, 1)

/**
 *  错误时连线颜色
 */
#define CircleConnectLineErrorColor rgba(255,255,255,1)//(254, 82, 92, 1)
 ...
 *  警告状态下文字提示的颜色
 */
#define textColorWarningState rgba(255,255,255,1)//(254, 82, 92, 1)
